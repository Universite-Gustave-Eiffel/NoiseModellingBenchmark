...
GROOVY_SCRIPT="nm_version/src/main/groovy/clisson/runscriptV5.0.groovy"
GROOVY_SCRIPT_v6="nm_version/src/main/groovy/clisson/runscriptV6.0.groovy"

INPUT_DIR="input"
OUTPUT_DIR="output/clisson"
WEBSITE_DIR="website"
DATA_DIR="$WEBSITE_DIR/data/clisson"
...
run_simulation() {
    ...
    if [ ! -f "$stats_file" ]; then
        local groovy_out="output/clisson/${version}/stats_${version}.json"
